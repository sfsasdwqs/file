...
public class usedAddresssVO implements SOAPObject, Serializable {
    public String _CITY_NAME = null;
    public String _COUNT_NUM = null;
    ...
    public void addElementsToNode(XmlSerializer xml) throws IOException {
        ...
        if (this._COUNT_NUM != null) {
            xml.startTag(null, "COUNT_NUM");
            xml.text(this._COUNT_NUM);
            xml.endTag(null, "COUNT_NUM");
        }
        ...
        try {
            ...
            while (next != 3) {
                if (next == 2) {
                    ...
                    } else if ("COUNT_NUM".equals(parser.getName())) {
                        this._COUNT_NUM = parser.nextText();
