...
public class rescheduleFlightInfoResultVO extends bookingResponseBaseVO implements SOAPObject, Serializable {
    public String _MESSAGE = null;
    public List<rescheduleFlightSegmentInfoVO> _RESCHEDULE_FLIGHT_INFOS = null;
    ...
    public void addElementsToNode(XmlSerializer xml) throws IOException {
        ...
        List<rescheduleFlightSegmentInfoVO> list = this._RESCHEDULE_FLIGHT_INFOS;
            ...
            while (next != 3) {
                if (next == 2) {
                    if ("MESSAGE".equals(parser.getName())) {
                        ...
                        this._RESCHEDULE_FLIGHT_INFOS.add(rescheduleflightsegmentinfovo);
