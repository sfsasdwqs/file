...
public class getAuthCodeParamResultVO extends bookingResponseBaseVO implements SOAPObject {
    public String _PARAM_STR = null;
    ...
    public void addElementsToNode(XmlSerializer xml) throws IOException {
        if (this._PARAM_STR != null) {
            xml.startTag(null, "PARAM_STR");
            xml.text(this._PARAM_STR);
            xml.endTag(null, "PARAM_STR");
        }
    ...
    public void parse(SOAPBinding binding, XmlPullParser parser) {
        try {
            ...
            while (next != 3) {
                if (next == 2) {
                    if ("PARAM_STR".equals(parser.getName())) {
                        this._PARAM_STR = parser.nextText();
